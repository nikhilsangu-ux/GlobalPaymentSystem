    ...
    <div class="box">
      ...
      <div class="alert-box">
        <div class="alert-scroll">
          <div class="alert danger">🚨 128 payments stuck at bank</div>
          <div class="alert warning">⚠ Retry spike on Gateway X</div>
          <div class="alert danger">❌ SLA breach detected</div>
          <div class="alert success">✔ Fraud activity normal</div>
...
<footer>Global Payment Intelligence System • Unified View</footer>
